...
import '../BLOC/profile/cubit/profile_cubit.dart';
    ...
    return Scaffold(
        ...
        body: BlocConsumer<ProfileCubit, ProfileState>(
          listener: (context, profileState) {
            if (profileState is ProfileIsFailed) {
              Commons().showSnackBarInfo2(context, profileState.message!);
            }
          },
          builder: (context, profileState) {
            ...
            } else if (profileState is ProfileIsSucces) {}
            {
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          IconButton(
                            onPressed: () => context.go('/editprofil'),
