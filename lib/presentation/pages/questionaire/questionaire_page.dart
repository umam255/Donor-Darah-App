        ...
        body: BlocListener<QuestionaireCubit, QuestionaireState>(
          listener: (context, questionaireState) {
            if (questionaireState is QuestionaireIsError) {
              // Commons().showSnackBarErrorr(context, "Url/Data Error");
              showDialog(
                context: context,
                builder: (BuildContext context) {
                  return AlertDialog(
                    ...
                    content: const Text('Pendaftaran Donor Berhsail',
              ...
              Future.delayed(
                ...
                () {
                  context.goNamed(Routes.detailagenda);
                },
              );
                              ...
                              showDialog(
                                ...
                                builder: (BuildContext context) {
                                  return AlertDialog(
                                    ...
                                    content: const Text(
                                        'Apakah kamu yakin data kuesioner sudah benar ?'),
                                    actions: [
                                      TextButton(
                                        onPressed: () {
                                          Navigator.pop(context);
                                      ...
                                      TextButton(
                                        onPressed: () {
                                          BlocProvider.of<QuestionaireCubit>(
                                                  context)
                                              .btnQuestionaire(1, answers);
                                          Navigator.pop(context);
                                        },
                                        style: TextButton.styleFrom(
                                          foregroundColor: BaseColor.red,
